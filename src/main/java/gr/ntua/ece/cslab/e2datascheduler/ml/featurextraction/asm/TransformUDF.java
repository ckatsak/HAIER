...
/**
 * This class transforms the Map skeleton by inserting the udf call in it.
 */
public class TransformUDF {
    ...
    /**
     * This class initiates the transformation by spotting the appropriate function in the skeleton and calling the adapter for it.
     */
    ...
    public static class MapMethodAdapter extends LocalVariablesSorter {
        ...
        public void visitCode() {
            ...
            //mv.visitFieldInsn(Opcodes.GETFIELD, "org/apache/flink/runtime/asm/map/MapASMSkeleton", "udf", "L" + mapUserClassName + ";");
    ...
    /**
     * This class creates a field in the skeleton class, which will be used
     * to call the user function on the map skeleton.
     */
    public static class MapConstructorAdapter extends LocalVariablesSorter {
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
            ...
            if (Opcodes.INVOKESPECIAL == opcode) {
                ...
                //mv.visitFieldInsn(Opcodes.PUTFIELD, "org/apache/flink/runtime/asm/map/MapASMSkeleton", "udf", "L" + mapUserClassName + ";");
    ...
    /**
     * This class creates a field in the skeleton class, which will be used
     * to call the user function on the reduce skeleton.
     */
